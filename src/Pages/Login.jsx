    ...
    <div>
      <div className='flex flex-row gap-20 items-center justify-center h-96 sm:h-64 md:h-80 lg:h-96 pt-20'>
        <div className='flex flex-col items-center'>
          ...
          <p className='text-3xl'>Continue your journey of investing and innovation </p>
        </div>
        <form 
          onSubmit={handleLogin}
          className='flex flex-col items-center rounded-xl  border-zinc-600 p-5 sm:h-auto md:h-auto lg:h-auto shadow-2xl'
        >
          <p className='text-2xl text-blue-600 font-semibold pb-3'>Welcome Back!</p>
          ...
          <p>First time here?</p>
          <Link to='/signup' className='text-blue-500 underline underline-offset-1'>Register</Link>
        </form>
      </div>
    </div>
  )
